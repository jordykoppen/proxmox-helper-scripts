...
### 🚀 Updated Scripts
  ...
  - Fix Omada installer [@JcMinarro](https://github.com/JcMinarro) ([#2625](https://github.com/jordykoppen/proxmox-helper-scripts/pull/2625))
...
- Fix: file replacement in Watcharr Update Script [@Clusters](https://github.com/Clusters) ([#2498](https://github.com/jordykoppen/proxmox-helper-scripts/pull/2498))
...
- Fix: some jsons (debian instead Debian in OS) [@MickLesk](https://github.com/MickLesk) ([#2311](https://github.com/jordykoppen/proxmox-helper-scripts/pull/2311))
...
- New Script: Prometheus Paperless-NGX Exporter [@andygrunwald](https://github.com/andygrunwald) ([#2153](https://github.com/jordykoppen/proxmox-helper-scripts/pull/2153))
...
- Rename & Optimize: Proxmox Backup Server (Renaming & Update fix) [@thost96](https://github.com/thost96) ([#2012](https://github.com/jordykoppen/proxmox-helper-scripts/pull/2012))
...
- Fix: Grist ran into a heap space during the update [@MickLesk](https://github.com/MickLesk) ([#1964](https://github.com/jordykoppen/proxmox-helper-scripts/pull/1964))
...
- New script: Baïkal [@bvdberg01](https://github.com/bvdberg01) ([#1913](https://github.com/jordykoppen/proxmox-helper-scripts/pull/1913))
...
- Update jellyseerr-install.sh to use Node 22 as required by latest Jellyseerr version [@pedrovieira](https://github.com/pedrovieira) ([#1535](https://github.com/jordykoppen/proxmox-helper-scripts/pull/1535))
...
- Improve Homarr Installation [@MickLesk](https://github.com/MickLesk) ([#1208](https://github.com/jordykoppen/proxmox-helper-scripts/pull/1208))
...
- Fix Script Homepage: add version during build step [@se-bastiaan](https://github.com/se-bastiaan) ([#1155](https://github.com/jordykoppen/proxmox-helper-scripts/pull/1155))
...
- [Archivebox] Fix wrong port being printed post install. [@Strana-Mechty](https://github.com/Strana-Mechty) ([#1105](https://github.com/jordykoppen/proxmox-helper-scripts/pull/1105))
...
- Fix Kernel-Clean for Proxmox 8.x [@MickLesk](https://github.com/MickLesk) ([#904](https://github.com/jordykoppen/proxmox-helper-scripts/pull/904))
...
- Zigbee2MQTT: Remove dev branch choice until v2.0.0 release [@havardthom](https://github.com/havardthom) ([#702](https://github.com/jordykoppen/proxmox-helper-scripts/pull/702))
...
- PostgreSQL: Change authentication method from peer to md5 for UNIX sockets [@michelroegl-brunner](https://github.com/michelroegl-brunner) ([#650](https://github.com/jordykoppen/proxmox-helper-scripts/pull/650))
- Fix stdout in unifi.sh [@michelroegl-brunner](https://github.com/michelroegl-brunner) ([#688](https://github.com/jordykoppen/proxmox-helper-scripts/pull/688))
- Fix `rm` bug in Vikunja update [@michelroegl-brunner](https://github.com/michelroegl-brunner) ([#692](https://github.com/jordykoppen/proxmox-helper-scripts/pull/692))
...
- Update Spelling 'Environment' in nginxproxymanager [@MathijsG](https://github.com/MathijsG) ([#676](https://github.com/jordykoppen/proxmox-helper-scripts/pull/676))

### 🌐 Website

- Update homepage.json documentation and website links [@patchmonkey](https://github.com/patchmonkey) ([#668](https://github.com/jordykoppen/proxmox-helper-scripts/pull/668))
...
- New Script: Onedev [@quantumryuu](https://github.com/quantumryuu) ([#612](https://github.com/jordykoppen/proxmox-helper-scripts/pull/612))

### 🚀 Updated Scripts

- Script Update: SnipeIT [@michelroegl-brunner](https://github.com/michelroegl-brunner) ([#641](https://github.com/jordykoppen/proxmox-helper-scripts/pull/641))
...
- New Script: Hoarder LXC [@vhsdream](https://github.com/vhsdream) ([#567](https://github.com/jordykoppen/proxmox-helper-scripts/pull/567))
- New script: SnipeIT LXC [@michelroegl-brunner](https://github.com/michelroegl-brunner) ([#538](https://github.com/jordykoppen/proxmox-helper-scripts/pull/538))
- New Script: Glance [@quantumryuu](https://github.com/quantumryuu) ([#595](https://github.com/jordykoppen/proxmox-helper-scripts/pull/595))
- New script: Unbound LXC [@wimb0](https://github.com/wimb0) ([#547](https://github.com/jordykoppen/proxmox-helper-scripts/pull/547))
- New script: Mylar3 LXC [@davalanche](https://github.com/davalanche) ([#554](https://github.com/jordykoppen/proxmox-helper-scripts/pull/554))

### 🚀 Updated Scripts

- Stirling-PDF: replace dependency for v0.35.0 and add check and fix in stirling-pdf.sh [@vhsdream](https://github.com/vhsdream) ([#614](https://github.com/jordykoppen/proxmox-helper-scripts/pull/614))
- qbittorrent: do not override the configuration port in systemd [@zdraganov](https://github.com/zdraganov) ([#618](https://github.com/jordykoppen/proxmox-helper-scripts/pull/618))

### 🌐 Website

- chore: Update unbound logo to have only the actual logo [@BramSuurdje](https://github.com/BramSuurdje) ([#648](https://github.com/jordykoppen/proxmox-helper-scripts/pull/648))
- fix: vaultwarden info mismatch [@BramSuurdje](https://github.com/BramSuurdje) ([#645](https://github.com/jordykoppen/proxmox-helper-scripts/pull/645))
- Wallos json fix [@quantumryuu](https://github.com/quantumryuu) ([#630](https://github.com/jordykoppen/proxmox-helper-scripts/pull/630))
...
- Convert line endings in the-lounge.sh [@jamezpolley](https://github.com/jamezpolley) ([#599](https://github.com/jordykoppen/proxmox-helper-scripts/pull/599))

### 🌐 Website

- add some Information for Monitor-All Script [@MickLesk](https://github.com/MickLesk) ([#605](https://github.com/jordykoppen/proxmox-helper-scripts/pull/605))
...
- New Script: The Lounge IRC [@quantumryuu](https://github.com/quantumryuu) ([#571](https://github.com/jordykoppen/proxmox-helper-scripts/pull/571))
- New Script: LubeLogger [@quantumryuu](https://github.com/quantumryuu) ([#574](https://github.com/jordykoppen/proxmox-helper-scripts/pull/574))
- New Script: Inspircd [@quantumryuu](https://github.com/quantumryuu) ([#576](https://github.com/jordykoppen/proxmox-helper-scripts/pull/576))

### 🚀 Updated Scripts

- Fix msg_error on zwave-js-ui [@MickLesk](https://github.com/MickLesk) ([#585](https://github.com/jordykoppen/proxmox-helper-scripts/pull/585))
- Fix Kimai Apache2 Rights [@MickLesk](https://github.com/MickLesk) ([#577](https://github.com/jordykoppen/proxmox-helper-scripts/pull/577))
...
- Fix Z-Wave JS UI script [@MickLesk](https://github.com/MickLesk) ([#546](https://github.com/jordykoppen/proxmox-helper-scripts/pull/546))
  - [Migration guide](https://github.com/jordykoppen/proxmox-helper-scripts/discussions/635)

### 🚀 Updated Scripts

- Add vitest, add json validation tests, fix broken json files [@havardthom](https://github.com/havardthom) ([#566](https://github.com/jordykoppen/proxmox-helper-scripts/pull/566))
- Add update script to Pocketbase [@dsiebel](https://github.com/dsiebel) ([#535](https://github.com/jordykoppen/proxmox-helper-scripts/pull/535))
- Fix MongoDB install in Unifi script [@havardthom](https://github.com/havardthom) ([#564](https://github.com/jordykoppen/proxmox-helper-scripts/pull/564))
- Remove changing DISK_REF for zfspool mikrotik-routeros.sh [@tjcomserv](https://github.com/tjcomserv) ([#529](https://github.com/jordykoppen/proxmox-helper-scripts/pull/529))

### 🌐 Website

- Show Changelog on Mobile Devices [@MickLesk](https://github.com/MickLesk) ([#558](https://github.com/jordykoppen/proxmox-helper-scripts/pull/558))
...
- Zabbix: Use Agent2 as Default | Update Script added | some other Improvements [@MickLesk](https://github.com/MickLesk) ([#527](https://github.com/jordykoppen/proxmox-helper-scripts/pull/527))

### 🚀 Updated Scripts

- Fix: install mosquitto from mosquitto repo [@dsiebel](https://github.com/dsiebel) ([#534](https://github.com/jordykoppen/proxmox-helper-scripts/pull/534))
- Patch Netbird Script | Container Boot-Check | Debian/Ubuntu Only [@MickLesk](https://github.com/MickLesk) ([#528](https://github.com/jordykoppen/proxmox-helper-scripts/pull/528))
- Install MongoDB 4.2 for non-AVX CPUs in Unifi LXC [@ColinOppenheim](https://github.com/ColinOppenheim) ([#319](https://github.com/jordykoppen/proxmox-helper-scripts/pull/319))

### 🌐 Website

- Fix json error in zabbix.json [@havardthom](https://github.com/havardthom) ([#543](https://github.com/jordykoppen/proxmox-helper-scripts/pull/543))
- Fix another json error in add-netbird-lxc.json [@havardthom](https://github.com/havardthom) ([#545](https://github.com/jordykoppen/proxmox-helper-scripts/pull/545))
...
- Fix Vikunja install script to prevent database deletion upon updating [@vhsdream](https://github.com/vhsdream) ([#524](https://github.com/jordykoppen/proxmox-helper-scripts/pull/524))
...
- Remove Scrypted script [@MickLesk](https://github.com/MickLesk) ([#511](https://github.com/jordykoppen/proxmox-helper-scripts/pull/511))
  - Because of request from Scrypted maintainer: [#494](https://github.com/jordykoppen/proxmox-helper-scripts/issues/494)
  - Official Scrypted script can be used instead: https://docs.scrypted.app/installation.html#proxmox-ve

### 🚀 Updated Scripts

- Fix bugs in Calibre-Web update [@havardthom](https://github.com/havardthom) ([#517](https://github.com/jordykoppen/proxmox-helper-scripts/pull/517))
- Fix upload folder in listmonk LXC [@bvdberg01](https://github.com/bvdberg01) ([#515](https://github.com/jordykoppen/proxmox-helper-scripts/pull/515))

### 🌐 Website

- Fix website url in Zoraxy documentation [@miggi92](https://github.com/miggi92) ([#506](https://github.com/jordykoppen/proxmox-helper-scripts/pull/506))
...
- New script: listmonk LXC [@bvdberg01](https://github.com/bvdberg01) ([#442](https://github.com/jordykoppen/proxmox-helper-scripts/pull/442))

### 🧰 Maintenance

- Add release title to github-release.yml [@havardthom](https://github.com/havardthom) ([#481](https://github.com/jordykoppen/proxmox-helper-scripts/pull/481))
...
- Fix Actual Budget install missing build tools [@cour64](https://github.com/cour64) ([#455](https://github.com/jordykoppen/proxmox-helper-scripts/pull/455))
- Fix Vikunja Update [@MickLesk](https://github.com/MickLesk) ([#440](https://github.com/jordykoppen/proxmox-helper-scripts/pull/440))
- Patch PostInstall-Script to PVE 8.3 | Add PVE 8.3 in Security [@MickLesk](https://github.com/MickLesk) ([#431](https://github.com/jordykoppen/proxmox-helper-scripts/pull/431))

### 🌐 Website

- Frontend: fix reported issue with json-editor page and add OS select in installmethod [@BramSuurdje](https://github.com/BramSuurdje) ([#426](https://github.com/jordykoppen/proxmox-helper-scripts/pull/426))
- Fixed Typo [@BenBakDev](https://github.com/BenBakDev) ([#441](https://github.com/jordykoppen/proxmox-helper-scripts/pull/441))

### 🧰 Maintenance

- Fix newline issue in changelog pr [@havardthom](https://github.com/havardthom) ([#474](https://github.com/jordykoppen/proxmox-helper-scripts/pull/474))
- Remove newline in changelog-pr action [@havardthom](https://github.com/havardthom) ([#461](https://github.com/jordykoppen/proxmox-helper-scripts/pull/461))
- Add action that creates github release based on CHANGELOG.md [@havardthom](https://github.com/havardthom) ([#462](https://github.com/jordykoppen/proxmox-helper-scripts/pull/462))
...
- Add new LXC: NextPVR [@MickLesk](https://github.com/MickLesk) ([#391](https://github.com/jordykoppen/proxmox-helper-scripts/pull/391))
- Add new LXC: Kimai [@MickLesk](https://github.com/MickLesk) ([#397](https://github.com/jordykoppen/proxmox-helper-scripts/pull/397))

### 🚀 Updated Scripts

- Add .env file support for HomeBox [@404invalid-user](https://github.com/404invalid-user) ([#383](https://github.com/jordykoppen/proxmox-helper-scripts/pull/383))
- RDTClient Remove .NET 8.0 | Add .NET 9.0 [@MickLesk](https://github.com/MickLesk) ([#413](https://github.com/jordykoppen/proxmox-helper-scripts/pull/413))
- Remove old resource message from vaultwarden [@havardthom](https://github.com/havardthom) ([#402](https://github.com/jordykoppen/proxmox-helper-scripts/pull/402))

### 🌐 Website

- Add PostInstall Documentation to zigbee2mqtt.json [@MickLesk](https://github.com/MickLesk) ([#411](https://github.com/jordykoppen/proxmox-helper-scripts/pull/411))
- Fix incorrect hdd values in json files [@havardthom](https://github.com/havardthom) ([#403](https://github.com/jordykoppen/proxmox-helper-scripts/pull/403))
- Website: Add discord link to navbar [@BramSuurdje](https://github.com/BramSuurdje) ([#405](https://github.com/jordykoppen/proxmox-helper-scripts/pull/405))

### 🧰 Maintenance

- Use github app in changelog-pr.yml and add auto approval [@havardthom](https://github.com/havardthom) ([#416](https://github.com/jordykoppen/proxmox-helper-scripts/pull/416))
...
- LinkWarden: Moved PATH into service [@newzealandpaul](https://github.com/newzealandpaul) ([#376](https://github.com/jordykoppen/proxmox-helper-scripts/pull/376))

### 🌐 Website

- Replace dash "-" with "/" in metadata [@newzealandpaul](https://github.com/newzealandpaul) ([#374](https://github.com/jordykoppen/proxmox-helper-scripts/pull/374))
- Proxmox VE Cron LXC Updater: Add tteck's notes. [@newzealandpaul](https://github.com/newzealandpaul) ([#378](https://github.com/jordykoppen/proxmox-helper-scripts/pull/378))
...
- Fix Wallos Update [@MickLesk](https://github.com/MickLesk) ([#339](https://github.com/jordykoppen/proxmox-helper-scripts/pull/339))
- Linkwarden: Move Secret Key above in install.sh [@MickLesk](https://github.com/MickLesk) ([#356](https://github.com/jordykoppen/proxmox-helper-scripts/pull/356))
- Linkwarden: add gnupg to installed dependencies [@erfansamandarian](https://github.com/erfansamandarian) ([#349](https://github.com/jordykoppen/proxmox-helper-scripts/pull/349))

### 🌐 Website

- Add *Arr Suite category for Website [@MickLesk](https://github.com/MickLesk) ([#370](https://github.com/jordykoppen/proxmox-helper-scripts/pull/370))
- Refactor Buttons component to use a ButtonLink for cleaner code, simplifying the source URL generation and layout [@BramSuurdje](https://github.com/BramSuurdje) ([#371](https://github.com/jordykoppen/proxmox-helper-scripts/pull/371))

### 🧰 Maintenance

- [github]: add new Frontend_Report / Issue_Report & optimize config.yml [@MickLesk](https://github.com/MickLesk) ([#226](https://github.com/jordykoppen/proxmox-helper-scripts/pull/226))
- [chore] Update FUNDING.yml [@MickLesk](https://github.com/MickLesk) ([#352](https://github.com/jordykoppen/proxmox-helper-scripts/pull/352))
...
- Massive Update - Remove old storage check, add new storage and resource check to all scripts - Remove downscaling with pct set [@MickLesk](https://github.com/MickLesk) ([#333](https://github.com/jordykoppen/proxmox-helper-scripts/pull/333))

### ✨ New Scripts

- new scripts for NetBox [@bvdberg01](https://github.com/bvdberg01) ([#308](https://github.com/jordykoppen/proxmox-helper-scripts/pull/308))

### 🚀 Updated Scripts

- Support SSE 4.2 in Frigate script [@anishp55](https://github.com/anishp55) ([#328](https://github.com/jordykoppen/proxmox-helper-scripts/pull/328))
- Bugfix: Wallos Patch (Cron Log & Media Backup)  [@MickLesk](https://github.com/MickLesk) ([#331](https://github.com/jordykoppen/proxmox-helper-scripts/pull/331))
- Linkwarden - Harmonize Script, Add Monolith & Bugfixing [@MickLesk](https://github.com/MickLesk) ([#306](https://github.com/jordykoppen/proxmox-helper-scripts/pull/306))
- Fix optional installs in Cockpit LXC [@havardthom](https://github.com/havardthom) ([#317](https://github.com/jordykoppen/proxmox-helper-scripts/pull/317))

### 🌐 Website

- Added additional instructions to nginxproxymanager [@newzealandpaul](https://github.com/newzealandpaul) ([#329](https://github.com/jordykoppen/proxmox-helper-scripts/pull/329))

### 🧰 Maintenance

- Verify changes before commit in changelog-pr.yml [@havardthom](https://github.com/havardthom) ([#310](https://github.com/jordykoppen/proxmox-helper-scripts/pull/310))
...
- Add Komga LXC [@DysfunctionalProgramming](https://github.com/DysfunctionalProgramming) ([#275](https://github.com/jordykoppen/proxmox-helper-scripts/pull/275))

### 🚀 Updated Scripts

- Tweak: Patch Prometheus for v.3.0.0 [@MickLesk](https://github.com/MickLesk) ([#300](https://github.com/jordykoppen/proxmox-helper-scripts/pull/300))
- Wavelog - Small Adjustment [@HB9HIL](https://github.com/HB9HIL) ([#292](https://github.com/jordykoppen/proxmox-helper-scripts/pull/292))

### 🌐 Website

- Add Note for Komga Installation (Website)  [@MickLesk](https://github.com/MickLesk) ([#303](https://github.com/jordykoppen/proxmox-helper-scripts/pull/303))
- Fix Komga logo [@havardthom](https://github.com/havardthom) ([#298](https://github.com/jordykoppen/proxmox-helper-scripts/pull/298))

### 🧰 Maintenance

- Add github workflow for automatic changelog PR  [@havardthom](https://github.com/havardthom) ([#299](https://github.com/jordykoppen/proxmox-helper-scripts/pull/299))
- Use website label in autolabeler [@havardthom](https://github.com/havardthom) ([#297](https://github.com/jordykoppen/proxmox-helper-scripts/pull/297))

## 2024-11-16

### Changed

- **Recyclarr LXC** [(View Source)](https://github.com/jordykoppen/proxmox-helper-scripts/blob/main/install/recyclarr-install.sh)
  - NEW Script
- **Wavelog LXC** [(View Source)](https://github.com/jordykoppen/proxmox-helper-scripts/blob/main/install/wavelog-install.sh)
  - NEW Script
- **Vaultwarden LXC:** RAM has now been increased to 6144 MB [(PR)](https://github.com/jordykoppen/proxmox-helper-scripts/pull/285)
  - Breaking Change
...
- **Bookstack LXC** [(View Source)](https://github.com/jordykoppen/proxmox-helper-scripts/blob/main/install/bookstack-install.sh)
  - NEW Script
- **Vikunja LXC** [(View Source)](https://github.com/jordykoppen/proxmox-helper-scripts/blob/main/install/vikunja-install.sh)
  - NEW Script
...
- **Automatic Update of Repository:** The update function now uses the new repository `community-scripts/ProxmoxVE` for Debian/Ubuntu LXC containers.
  ...
  ```bash
  bash -c "$(wget -qLO - https://github.com/jordykoppen/proxmox-helper-scripts/raw/main/misc/update-repo.sh)"

## 2024-10-31

### Changed

- **NZBGet LXC** [(View Source)](https://github.com/jordykoppen/proxmox-helper-scripts/blob/main/install/nzbget-install.sh)
  - NEW Script
- **Memos LXC** [(View Source)](https://github.com/jordykoppen/proxmox-helper-scripts/blob/main/install/memos-install.sh)
  - NEW Script
...
- **Open WebUI LXC** [(Commit)](https://github.com/jordykoppen/proxmox-helper-scripts/commit/8a21f6e7f025a911865395d4c0fa9a001bd0d512)
...
- **AdventureLog LXC** [(View Source)](https://github.com/jordykoppen/proxmox-helper-scripts/blob/main/install/adventurelog-install.sh)
  - NEW Script
...
- **Zoraxy LXC** [(Commit)](https://github.com/jordykoppen/proxmox-helper-scripts/commit/468a5d367ded4cf453a1507452e112ac3e234e2a)
...
- **Wallos LXC** [(View Source)](https://github.com/jordykoppen/proxmox-helper-scripts/blob/main/install/wallos-install.sh)
  - NEW Script
- **Open WebUI LXC** [(View Source)](https://github.com/jordykoppen/proxmox-helper-scripts/blob/main/install/openwebui-install.sh)
  - NEW Script
...
- **Cockpit LXC** [(View Source)](https://github.com/jordykoppen/proxmox-helper-scripts/blob/main/install/cockpit-install.sh)
  - NEW Script
- **Neo4j LXC** [(View Source)](https://github.com/jordykoppen/proxmox-helper-scripts/blob/main/install/neo4j-install.sh)
  - NEW Script
...
- **ArchiveBox LXC** [(View Source)](https://github.com/jordykoppen/proxmox-helper-scripts/blob/main/install/archivebox-install.sh)
  - NEW Script
...
- **evcc LXC** [(View Source)](https://github.com/jordykoppen/proxmox-helper-scripts/blob/main/install/evcc-install.sh)
  - NEW Script
...
- **MySQL LXC** [(View Source)](https://github.com/jordykoppen/proxmox-helper-scripts/blob/main/install/mysql-install.sh)
  - NEW Script
- **Tianji LXC** [(Commit)](https://github.com/jordykoppen/proxmox-helper-scripts/commit/4c83a790ac9b040da1f11ad2cbe13d3fc5f480e9)
  - Breaking Change
...
- **Home Assistant Core LXC** [(Commit)](https://github.com/jordykoppen/proxmox-helper-scripts/commit/f2937febe69b2bad8b3a14eb84aa562a8f14cc6a) [(Commit)](https://github.com/jordykoppen/proxmox-helper-scripts/commit/f2966ced7f457fd506f865f7f5b70ea12c4b0049)
  - Refactor Code
  - Breaking Change
...
- **HomeBox LXC** [(View Source)](https://github.com/jordykoppen/proxmox-helper-scripts/blob/main/install/homebox-install.sh)
  - NEW Script
- **Zipline LXC** [(View Source)](https://github.com/jordykoppen/proxmox-helper-scripts/blob/main/install/zipline-install.sh)
  - NEW Script
...
- **Tianji LXC** [(View Source)](https://github.com/jordykoppen/proxmox-helper-scripts/blob/main/install/tianji-install.sh)
  - NEW Script
...
- **WireGuard LXC** [(Commit)](https://github.com/jordykoppen/proxmox-helper-scripts/commit/723365a79df7cc0fd29b1af8f7ef200a7e0921b1)
  - Refactor Code
  - Breaking Change
...
- **CommaFeed LXC** [(Commit)](https://github.com/jordykoppen/proxmox-helper-scripts/commit/0a33d1739ec3a49011411929bd46a260e92e99f9)
  - Refactor Code
  - Breaking Change
...
- **lldap LXC** [(View Source)](https://github.com/jordykoppen/proxmox-helper-scripts/blob/main/install/lldap-install.sh)
  - NEW Script
...
- **Gitea LXC** [(View Source)](https://github.com/jordykoppen/proxmox-helper-scripts/blob/main/install/gitea-install.sh)
  - NEW Script
...
- **All Scripts** [(Commit)](https://github.com/jordykoppen/proxmox-helper-scripts/commit/39ea1d4a20b83c07d084ebafdc811eec3548f289)
...
- **Kubo LXC** [(View Source)](https://github.com/jordykoppen/proxmox-helper-scripts/blob/main/install/kubo-install.sh)
  - NEW Script
- **RabbitMQ LXC** [(View Source)](https://github.com/jordykoppen/proxmox-helper-scripts/blob/main/install/rabbitmq-install.sh)
  - NEW Script
- **Scrutiny LXC**
...
- **MySpeed LXC** [(View Source)](https://github.com/jordykoppen/proxmox-helper-scripts/blob/main/install/myspeed-install.sh)
  - NEW Script
...
- **PeaNUT LXC** [(View Source)](https://github.com/jordykoppen/proxmox-helper-scripts/blob/main/install/peanut-install.sh)
  - NEW Script
- **Website**
  - If the Changelog has changed recently, the link on the website will pulse.
- **Spoolman LXC** [(View Source)](https://github.com/jordykoppen/proxmox-helper-scripts/blob/main/install/spoolman-install.sh)
  - NEW Script
...
- **MeTube LXC** [(View Source)](https://github.com/jordykoppen/proxmox-helper-scripts/blob/main/install/metube-install.sh)
  - NEW Script
- **Matterbridge LXC** [(View Source)](https://github.com/jordykoppen/proxmox-helper-scripts/blob/main/install/matterbridge-install.sh)
  - NEW Script
- **Website**
...
- **Zabbix LXC** [(View Source)](https://github.com/jordykoppen/proxmox-helper-scripts/blob/main/install/zabbix-install.sh)
  - NEW Script
...
- **Petio LXC** [(View Source)](https://github.com/jordykoppen/proxmox-helper-scripts/blob/main/install/petio-install.sh)
  - NEW Script
- **Website**
...
- **FlareSolverr LXC** [(View Source)](https://github.com/jordykoppen/proxmox-helper-scripts/blob/main/install/flaresolverr-install.sh)
  - NEW Script
...
- **Advanced Settings** [(Commit)](https://github.com/jordykoppen/proxmox-helper-scripts/commit/fc9dff220b4ea426d3a75178ad8accacae4683ca)
...
- **Proxmox VE Monitor-All**
  - Skip instances based on onboot and templates. [8c2a3cc](https://github.com/jordykoppen/proxmox-helper-scripts/commit/8c2a3cc4d774fa13d17f695d6bdf9a4deedb1372). 
...
- **[User Submitted Guides](https://github.com/jordykoppen/proxmox-helper-scripts/blob/main/USER_SUBMITTED_GUIDES.md)**
...
- **Proxmox LXC Updater** 
  - Now updates Ubuntu, Debian, Devuan, Alpine Linux, CentOS-Rocky-Alma, Fedora, ArchLinux [(@Uruknara)](https://github.com/jordykoppen/proxmox-helper-scripts/commits?author=Uruknara)
